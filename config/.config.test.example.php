...
// SSPanel-UIM test configuration TEMPLATE.
// Copy this file to config/.config.test.php and fill in your local test DB
// credentials. NEVER commit config/.config.test.php (it may hold secrets).
// See tests/README.md for the full test-DB setup guide.

//基本设置---------------------------------------------------------------------------------------------------------------
$_ENV['key'] = 'CHANGE_ME';    // Cookie加密密钥，请务必修改此key为随机字符串
...
$_ENV['muKey'] = 'CHANGE_ME';          // WebAPI密钥，用于节点服务端与面板通信，请务必修改此key为随机字符串
...
$_ENV['db_socket'] = '';
$_ENV['db_database'] = 'sspanel_test'; // 数据库名（测试库，与生产库分开）
$_ENV['db_username'] = 'sspanel_test'; // 数据库用户名
$_ENV['db_password'] = 'CHANGE_ME';    // 用户密码
...
$_ENV['redis_db'] = 15;               // Redis数据库编号，测试建议使用独立编号（如 15）避免污染开发数据
