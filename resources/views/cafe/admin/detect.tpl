...
<div x-data="{ showCreate: false }">
    ...
    <div x-data="cafeTable('/admin/detect/ajax', 'rules')" class="c-card">
        ...
        <div class="table-card overflow-x-auto">
            <table data-column-storage="cafe.admin.detect.columns.v1" data-column-widths="100,240,320,320,160,110" data-column-minimums="80,140,160,160,110,110" data-fixed-last>
                <thead>
                <tr>
                    <th>ID</th>
                    <th>规则名称</th>
