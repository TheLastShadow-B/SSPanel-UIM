...
<div class="mb-6 flex flex-wrap items-center justify-between gap-3">
    <div>
        <h2 class="text-2xl font-semibold tracking-tight">账单</h2>
        <p class="text-faint mt-1 text-sm">系统中所有账单</p>
    </div>
    <span></span>
</div>

<div x-data="cafeTable('/admin/invoice/ajax', 'invoices')" class="c-card">
        ...
        <table>
            ...
            <template x-for="row in paged" :key="row.id">
                <tr>
                    ...
                    <td class="text-faint text-xs" x-text="row.pay_time"></td>
                    <td><div class="flex justify-end gap-1.5">
                        <a class="btn-secondary btn-sm" :href="'/admin/invoice/' + row.id + '/view'">查看</a>
                    </div></td>
                </tr>
            </template>
            </tbody>
