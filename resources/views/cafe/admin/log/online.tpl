...
<div x-data="cafeServerTable('/admin/online/ajax', 'onlines', ['id', 'user_id', 'node_name', 'ip', 'location', 'first_time', 'last_time'])" class="c-card">
    ...
    <div class="table-card overflow-x-auto">
        <table data-column-storage="cafe.admin.log.online.columns.v1" data-column-widths="100,100,240,230,230,220,220" data-column-minimums="100,80,140,140,140,160,160">
            <thead>
            <tr>
                <th>事件ID</th>
                <th>用户</th>
