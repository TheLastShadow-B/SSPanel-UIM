{include file='shell/admin_header.tpl' nav='log-gateway'}

<div class="mb-6 flex flex-wrap items-center justify-between gap-3">
    <div>
        <h2 class="text-2xl font-semibold tracking-tight">支付网关日志</h2>
        <p class="text-faint mt-1 text-sm">网关支付记录</p>
    </div>
    <span></span>
</div>

<div x-data="cafeTable('/admin/gateway/ajax', 'paylists')" class="c-card">
    ...
    <div class="table-card overflow-x-auto">
        <table data-column-storage="cafe.admin.log.gateway.columns.v1" data-column-widths="100,100,130,160,160,240,220,100" data-column-minimums="100,80,80,110,110,160,160,80">
            <thead>
            <tr>
                <th>事件ID</th>
                <th>用户</th>
            ...
            <template x-for="row in paged" :key="row.id">
                <tr>
                    ...
                    <td><span class="badge-neutral" x-text="row.gateway"></span></td>
                    <td class="max-w-52 truncate font-mono text-xs" x-text="row.tradeno"></td>
