...
<div x-data="cafeServerTable('/admin/detect/ban/ajax', 'bans', ['id', 'user_id', 'detect_number', 'ban_time', 'start_time', 'end_time', 'ban_end_time', 'all_detect_number'])" class="c-card">
    ...
    <div class="table-card overflow-x-auto">
        <table data-column-storage="cafe.admin.log.detect_ban.columns.v1" data-column-widths="100,100,130,142,220,220,220,130" data-column-minimums="100,80,100,142,160,160,160,100">
            <thead>
            <tr>
                <th>事件ID</th>
                <th>用户</th>
